...
import signupImage from '../../images/teacher-signup-image.svg';
...
const Singup = ({ onSetIsAuthenticated }) => {
   ...
   const handleSubmit = async e => {
      ...
      try {
         ...
         const respose = await fetch('/auth/teacher/signup', {
            method: 'POST',
         ...
         <div className='container py-4'>
            ...
            <div className='signup row border p-5 p-lg-4 mt-4 shadow container__round--corners justify-content-evenly align-items-center'>
               <div className='col-lg-5 me-lg-5'>
                  <form className='needs-validation' noValidate onSubmit={handleSubmit}>
                     ...
                     <div className='my-4'>
                        ...
                        <Link className='fw-bold link--color' to='/teacher/signin'>
                           Sign In
                        </Link>
                     </div>
                  </form>
               ...
               <div className='col-lg-5 my-lg-5'>
                  <img className='img-fluid d-none d-lg-block my-5' src={signupImage} alt='signup-illustration' />
               </div>
            </div>
         </div>
      </div>
