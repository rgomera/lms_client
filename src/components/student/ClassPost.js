...
import Comment from '../teacher/Comment';
...
const ClassPost = ({ student, classInstance, teacherId, post }) => {
                  ...
                  <div className='d-flex flex-wrap align-items-center'>
                     ...
                     {type === 'Assignment' && (
                        <Link
                           ...
                           title='Submit'
                           to={`/student/classes/class-post/${classInstance.class_id}/${teacherId}/${post.id}`}
                        >
                           <img src={submitIcon} />
                        </Link>
                     )}
                     {type === 'Quiz' && (
                        <Link
                           className='mt-2 mt-md-3'
                           title='Take Quiz'
                           to={`/student/classes/class-takequiz/${classInstance.class_id}/${teacherId}/${post.id}`}
                        >
                           <img src={quizIcon} />
                        </Link>
                     )}
         ...
         <div className='accordion accordion-flush'>
            <div className='accordion-item'>
               <h2 className='accordion-header'>
                  <button
                     className='accordion-button commentButton collapsed'
                     type='button'
